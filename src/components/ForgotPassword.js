...
const ForgotPassword = () => {
    ...
    const userValid = async () => {
        const res = await fetch(`https://webcode2newbackend.onrender.com/forgotpassword/${id}/${token}`, {
            method: "GET",
            headers: {
    ...
    const sendpassword = async (e) => {
        ...
        if (password === "") {
            ...
            const res = await fetch(`https://webcode2newbackend.onrender.com/${id}/${token}`, {
                method: "POST",
                headers: {
                    "Content-Type": "application/json"
                },
