...
const Adduser = () => {
    ...
    const addUserdata = async (e) => {
        ...
        const { fname, email,role , password, cpassword } = inpval;
        ...
        if (fname === "") {
            ...
            const data = await fetch("https://webcode2newbackend.onrender.com/register", {
                method: "POST",
                headers: {
            ...
            if (res.status === 200) {
                ...
                setInpval({ ...inpval, fname: "", email: "", role:"", password: "", cpassword: "" });
            }
        }
    }
